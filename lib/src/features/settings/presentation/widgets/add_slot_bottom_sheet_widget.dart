...
class AddSlotBottomSheetWidget extends StatefulWidget {
  final Function(String day, String startTime, String endTime)? onCreateSlot;
  ...
  static Future<void> show(
    ...
    Function(String day, String startTime, String endTime)? onCreateSlot,
  }) {
    return showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (_) => AddSlotBottomSheetWidget(onCreateSlot: onCreateSlot),
    );
  }
...
class _AddSlotBottomSheetWidgetState extends State<AddSlotBottomSheetWidget> {
  ...
  void _handleSubmit() {
    ...
    widget.onCreateSlot?.call(_selectedDay!, startTimeStr, endTimeStr);
  }
