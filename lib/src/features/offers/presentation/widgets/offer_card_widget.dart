...
class OfferCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final borderColor = isActive ? AppColor.green : AppColor.bright_red;
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                // ── Top Header Banner with Coupon Code & Status Chip ─────
                Container(
                  padding:
                      EdgeInsets.symmetric(horizontal: 14.w, vertical: 8.h),
                  decoration: BoxDecoration(
                    color: isActive
                        ? AppColor.green.withValues(alpha: 0.06)
                        : AppColor.bright_red.withValues(alpha: 0.06),
  ...
  Widget _buildInfoPill({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: highlight ? AppColor.orangeTint2 : AppColor.whiteShade,
